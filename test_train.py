...
train_images_path = '/kaggle/working/PJ1-MNIST/dataset/MNIST/train-images-idx3-ubyte.gz'
train_labels_path = '/kaggle/working/PJ1-MNIST/dataset/MNIST/train-labels-idx1-ubyte.gz'
